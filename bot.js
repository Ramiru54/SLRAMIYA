...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- දෝෂ වාර්තාව [RAMIYA] --*' + 
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ දෝෂ විසඳුම [RAMIYA] ⚕️*' + 
                                        '\n========== ```කියවීමේ දෝෂයකි!``` ==========' +
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ HATA ÇÖZÜMLEME [RAMIYA] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [RAMIYA] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                               ...
                               if (error.message.includes('URL')) {
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ දෝෂ විශ්ලේෂණය  [RAMIYA] ⚕️*' + 
                                        '\n========== ```දෝෂය විසඳා ඇත!``` ==========' +
